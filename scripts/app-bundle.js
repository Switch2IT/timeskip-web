    ...
    let RestApi = class RestApi {
        ...
        getWorklogs(organizationId, projectId, activityId, params) {
            ...
            return _asyncToGenerator(function* () {
                ...
                var data;
                if (params = undefined) {
                    data = yield _this27.getData("/organizations/".concat(organizationId).concat("/projects/").concat(projectId).concat("/activities/").concat(activityId).concat("/worklogs"));
                } else {
                    data = yield _this27.getDataWithParams("/organizations/".concat(organizationId).concat("/projects/").concat(projectId).concat("/activities/").concat(activityId).concat("/worklogs"), parameters);
                }
                if (data.statusCode < 400) {
                    return data.response;
                } else {
        ...
        getCurrentUserTimeLogReport(params) {
            ...
            return _asyncToGenerator(function* () {
                var data = yield _this50.getDataWithParams("/reports/loggedtime/users/current", params);
                if (data.statusCode < 400) {
                    return data.response;
                } else {
                    alert(data.statusCode.concat(' - ').concat(data.statusText));
...
define('timesheet',['exports', './organisaties/organisaties', './rest-api', 'aurelia-framework', 'aurelia-router', 'bootstrap'], function (exports, _organisaties, _restApi, _aureliaFramework, _aureliaRouter) {
    'use strict';
    ...
    let Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = class Home {
        ...
        getWorklogs() {
            ...
            return _asyncToGenerator(function* () {
                ...
                var logs = yield doc.api.getWorklogs(_this11.organization.id, _this11.project.id, _this11.activity.id, params);
